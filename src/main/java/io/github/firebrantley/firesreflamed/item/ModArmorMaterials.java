...
public class ModArmorMaterials {
    ...
    public static final RegistryEntry<ArmorMaterial> TITANIUM_ARMOR_MATERIAL =
            registerArmorMaterial("titanium",
                    () -> new ArmorMaterial(
    ...
    public static final RegistryEntry<ArmorMaterial> STEEL_ARMOR_MATERIAL =
            registerArmorMaterial("steel",
                    () -> new ArmorMaterial(
                            Util.make(new EnumMap<>(ArmorItem.Type.class), map -> {
                            ...
                            List.of(
                                    new ArmorMaterial.Layer(
                                            Identifier.of(FiresReflamed.MOD_ID, "steel")
                                    )
                            ),
                            0,
                            0
